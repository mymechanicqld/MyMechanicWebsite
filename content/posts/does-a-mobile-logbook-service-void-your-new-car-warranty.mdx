...
> Manufacturers and their authorised dealers cannot require consumers to have their vehicle serviced by an authorised dealer to keep their consumer guarantee rights and to maintain the manufacturer's warranty.

That is a direct paraphrase of the ACCC's position. The dealership cannot tie warranty to having you come back to them. What they can require, perfectly reasonably, is that the service is performed competently, on schedule, by a qualified mechanic, using appropriate parts. Any qualified mechanic. Anywhere.
...
A customer of ours bought a new Mazda CX-5 from a dealer in Brisbane. He had four logbook services with us over three years (one minor every six months, alternating minor-major). At about 48,000 km, his vehicle developed an issue with the automatic transmission. The dealership initially refused warranty on the grounds that the transmission had not been "inspected through their workshop."

We provided the customer with copies of all four service invoices, showing the work done, the OEM filters fitted, and the manufacturer-spec transmission fluid we had topped up at the major service. The customer also produced the stamped logbook. The dealership performed the warranty repair, no further questions.

It was not even a difficult conversation. The records did the work.
