...
meta_description: "What a proper used-car pre-purchase inspection actually covers. A comprehensive checklist with what we look for and why, plus the red flags that usually mean walking away."
excerpt: "Buying a used car privately or from a dealer? Here is what an independent comprehensive inspection actually covers, what each item is checking for, and the red flags that usually mean walking away."
...
A proper pre-purchase inspection takes about 90 minutes to two hours. It covers four areas: under the bonnet, underneath, body and interior, and on the road. Within those four areas, we run a comprehensive checklist looking for everything from obvious problems (low oil, worn brakes, leaking radiator) to less obvious ones (signs of previous accident repair, hidden frame damage, transmission early-warning signs).

The inspection produces a written report with photos, emailed to you within four hours of completion. You use the report to walk away, to renegotiate the price, or to buy with confidence. In our experience, the inspection saves the buyer money in about nine out of ten cases. Sometimes a few hundred dollars in renegotiated service work. Sometimes thousands in walk-away calls on cars that turned out to have major hidden issues.

This article walks through every item on our comprehensive checklist, what we are looking for, and what each finding usually means for the buy decision.
...
We have done over 200 pre-purchase inspections across South East Queensland in the last few years. The inspection cost ($229 for standard 2WD, $279 for 4WDs and utes) almost always saves the buyer many multiples of that in renegotiation or in walking away from a bad deal.

## The real-world value

Three real examples from the last twelve months:

- **A 2017 Hilux dual-cab** in Coomera. The inspection found a hairline crack in the cylinder head (visible only with the right inspection mirror and lighting). The seller had not disclosed it. The customer walked. Saved cost: estimated $4,500 for a head replacement.
- **A 2019 Mazda CX-5** in Carindale. The inspection found uneven tyre wear pointing to a suspension issue, plus brakes nearing minimum. The customer renegotiated $1,400 off the price. We did the brake and suspension work the week after. Total customer outlay versus the original ask: about $2,200 cheaper.
- **A 2014 Ford Ranger** in Springfield. The inspection found nothing significant. Genuine fully-stamped log book, no accident history, no leaks. We told the customer it was as honest a used car as we had seen all year. He bought it. Inspection cost: $279. Confidence: priceless.

## How to book

If you have a used car you are looking at, the process is:

1. Call us on **0451 159 954** or use the [quote form](/book/) with the make, model, year, asking price and the seller's location.
2. We confirm the cost (typically $229 to $279 depending on the vehicle).
3. We coordinate the time with you and the seller. We attend at the seller's address.
4. The inspection takes 90 minutes to two hours.
5. We text you the headline result as soon as we are finished.
6. The written report with photos lands in your email within four hours.
