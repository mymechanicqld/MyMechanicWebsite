...
const SERVICES = [
  ...
  },
  {
    ...
    priceFrom: null,
    desc: 'Manufacturer-spec scheduled servicing with OEM filters and proper fluids. Warranty-safe under the Australian Consumer Law.',
    Icon: Gauge,
    priority: true,
  },
  {
    ...
    priceFrom: null,
    desc: 'Comprehensive inspection with a written report before you hand over the money on a used car. We meet you and the seller on-site.',
    Icon: ClipboardCheck,
    priority: false,
  },
  {
    ...
    priceFrom: null,
    desc: 'Heavy-duty replacement, delivered, installed, old battery responsibly recycled. Most jobs sorted in under 30 minutes.',
    Icon: Battery,
    priority: false,
  },
  {
